      ...
      >
        ...
        <div className="mt-7 grid gap-3 sm:grid-cols-2">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={loading}
            className="inline-flex order-1 items-center justify-center gap-2 rounded-xl bg-red-500 px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-red-500/20 transition hover:bg-red-600 active:scale-[.98] disabled:pointer-events-none disabled:opacity-60 sm:order-2"
          >
            {loading ? (
